...
public class Constants {
    ...
    public final static String FILE_UPLOAD_DIC = "C:\\gittask\\upload\\";//上传文件的默认url前缀，根据部署设置自行修改
    ...
    public final static int INDEX_GOODS_USERCHECKEDGOODS_NUMBER = 5;//首页最近看过
